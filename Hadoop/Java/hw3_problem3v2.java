 ...
 */
public class hw3_problem3v2 extends Configured implements Tool {
  ...
  public static class IntSumReducer 
	 ...
	 */
 	...
 	int res = ToolRunner.run(new Configuration(), (Tool) new hw3_problem3v2(), 	args);
...
public int run(String[] args) throws Exception {
	...
	job.setJarByClass(hw3_problem3v2.class);
